...
namespace Ucenje
{
    internal class E04UvjetnoGrananjeIF
    {
        ...
        public static void Izvedi()
        {
            ...
            int broj = 7; // ovo je kao da sam ispisao poruku u da je korisnik unio broj 7

            // operator == provjerava jednakost, on je tipka bool
            ...
            //Console.WriteLine("I ovo bih da je uvjet jednakost da je broj 7");
            ...
            if (broj > 0 || temp > 0) // Ako je prvi uvjet zadovoljen ne provejrava se drugi
            {
                Console.WriteLine("Toplo je");
            }
